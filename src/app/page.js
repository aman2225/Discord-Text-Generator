...
// import { IconUnderline, IconBold, IconTrash, IconChevronDown } from "@tabler/icons-react";
...
//     if (fgPickerOpened && fgButtonRef.current && !fgButtonRef.current.contains(event.target)) {
//       setFgPickerOpened(false);
//     }
    
//     if (bgPickerOpened && bgButtonRef.current && !bgButtonRef.current.contains(event.target)) {
...
//     let discordFormattedText = "```ansi\n";
//     const traverseNodes = (node) => {
//       if (node.nodeType === Node.TEXT_NODE) {
//         discordFormattedText += node.textContent;
//       } else if (node.nodeType === Node.ELEMENT_NODE) {
//         let text = "";
//         if (node.style.fontWeight === "bold") text += "**";
//         if (node.style.textDecoration === "underline") text += "__";

//         if (node.style.color) text += `\u001b[38;5;${convertColorToAnsi(node.style.color)}m`;
//         if (node.style.backgroundColor) text += `\u001b[48;5;${convertColorToAnsi(node.style.backgroundColor)}m`;

//         node.childNodes.forEach(traverseNodes);

//         if (node.style.color || node.style.backgroundColor) text += "\u001b[0m"; // Reset colors
//         if (node.style.textDecoration === "underline") text += "__";
//         if (node.style.fontWeight === "bold") text += "**";
//       }
//     };
...
//     setCopySuccess(true)
//     navigator.clipboard.writeText(discordFormattedText).then(() => {
//       alert("Copied to clipboard in Discord format!");
//     });
//   };
...
//     };
//     return colorMap[color] || 15; // Default to white if unknown
//   };
...
//         <Popover opened={fgPickerOpened} onClose={() => setFgPickerOpened(false)} position="bottom" withArrow>
//           <Popover.Target>
//             <Button 
...
//               compact
//             >
//               <div style={{ width: "16px", height: "16px", backgroundColor: foregroundColor, border: "1px solid #ccc", marginRight: "8px" }} />
//               FG
//             </Button>
//           </Popover.Target>
//           <Popover.Dropdown>
...
//                 <ActionIcon key={color} style={{
//                   backgroundColor: color, width: "20px", height: "20px",
//                   borderRadius: "4px", cursor: "pointer",
//                   border: foregroundColor === color ? "2px solid black" : "1px solid #ddd",
...
//         <Popover opened={bgPickerOpened} onClose={() => setBgPickerOpened(false)} position="bottom" withArrow>
//           <Popover.Target>
//             <Button 
//               variant="light" 
//               rightIcon={<IconChevronDown size={16} />}
...
//               compact
//             >
//               <div style={{ width: "16px", height: "16px", backgroundColor: backgroundColor, border: "1px solid #ccc", marginRight: "8px" }} />
//               BG
//             </Button>
//           </Popover.Target>
//           <Popover.Dropdown>
...
//                   backgroundColor: color, width: "20px", height: "20px",
//                   borderRadius: "4px", cursor: "pointer",
//                   border: backgroundColor === color ? "2px solid black" : "1px solid #ddd",
...
//         if (node.style.color || node.style.backgroundColor) text += "\u001b[0m";
//         if (node.style.textDecoration === "underline") text += "__";
//         if (node.style.fontWeight === "bold") text += "**";
//       }
//     };
...
//     <div style={{ maxWidth: "600px", margin: "auto", padding: "20px", textAlign: "center" }}>
//       <h1>
//         <strong>Discord</strong> <span style={{ color: "blue" }}>Colored</span> Text Generator
//       </h1>
//       <p>
...
//       <h3>Source Code</h3>
//       <p>
//         This app runs entirely in your browser and the source code is freely available on <a href="https://github.com">GitHub</a>.
//       </p>
...
// import { Popover, Group, ActionIcon, Button, Divider, Switch } from "@mantine/core";
// import { IconUnderline, IconBold, IconTrash, IconChevronDown , IconSun, IconMoon} from "@tabler/icons-react";
...
// import { Popover, Group, ActionIcon, Button, Divider, Notification, Text } from "@mantine/core";
...
//           Tip: Paste into Discord and the colors will appear automatically
//         </Text>
//       </div>
//     </MantineProvider>
//   );
